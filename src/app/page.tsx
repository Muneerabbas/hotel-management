    ...
    <div className="min-h-screen bg-[#F8F6F1] dark:bg-[#141210] text-[#1C1A16] dark:text-[#EDE9E0]">
      ...
      <header className="sticky top-0 z-50 bg-[#F8F6F1]/90 dark:bg-[#141210]/90 backdrop-blur border-b border-[#DDD8CC] dark:border-white/8">
        <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            <ThemeToggle />
            <Link href="/login" className="px-3 py-1.5 text-sm text-[#7A7060] dark:text-[#9A9080] hover:text-foreground transition-colors">
              Sign in
            </Link>
            <Link href="/register" className="ml-1 px-4 py-2 text-sm bg-[#2F4F2F] dark:bg-[#EDE9E0] text-[#F8F6F1] dark:text-[#141210] font-medium hover:opacity-90 transition-opacity">
              Start free →
            </Link>
          </div>
        </div>
      ...
      <section className="max-w-6xl mx-auto px-6 pt-20 pb-24">
        <div className="max-w-3xl">
          ...
          <p className="text-lg text-[#7A7060] dark:text-[#9A9080] leading-relaxed mb-8 max-w-xl">
            StayFlow gives you a live view of every room, records every guest with their ID, and builds your booking history automatically. Setup takes 5 minutes.
          </p>

          <div className="flex flex-wrap items-center gap-4 mb-12">
            <Link
              href="/register"
              className="inline-flex items-center gap-2.5 px-6 py-3 bg-[#2F4F2F] dark:bg-[#EDE9E0] text-[#F8F6F1] dark:text-[#141210] font-semibold text-sm hover:opacity-90 transition-opacity"
            >
      ...
      {/* Product mockup — visual floor plan */}
      <section className="bg-[#2F4F2F] dark:bg-[#1A2A1A] py-16">
        <div className="max-w-6xl mx-auto px-6">
          <p className="text-xs uppercase tracking-[0.2em] text-white/40 mb-8 text-center">Live room status — your entire hotel at a glance</p>

          {/* Fake dashboard preview */}
          <div className="bg-[#F8F6F1] dark:bg-[#1E1B17] border border-[#DDD8CC] dark:border-white/10 overflow-hidden max-w-3xl mx-auto">
            {/* Fake top bar */}
            <div className="flex items-center gap-2 px-4 py-3 border-b border-[#DDD8CC] dark:border-white/8 bg-white dark:bg-[#141210]">
            ...
            <div className="flex min-h-[280px]">
              {/* Fake sidebar */}
              <div className="w-36 bg-[#2F4F2F] shrink-0 p-3 space-y-1">
              ...
              <div className="flex-1 p-5">
                ...
                <div className="grid grid-cols-4 gap-1 mb-5">
                  {[
                    { l: 'Total', v: '35', c: '' },
                    { l: 'Available', v: '18', c: 'text-[#3A5F3A]' },
                    { l: 'Occupied', v: '14', c: 'text-[#C87941]' },
                    { l: 'Maint.', v: '3', c: 'text-[#7A6A55]' },
                  ].map(({ l, v, c }) => (
                    <div key={l} className="bg-white dark:bg-white/5 border border-[#DDD8CC] dark:border-white/8 px-2.5 py-2">
                      <div className="text-[10px] text-[#7A7060] mb-1">{l}</div>
                      <div className={`text-lg font-bold ${c}`}>{v}</div>
                    </div>
                  ))}
                </div>
                {/* Floor plan */}
                <div className="text-[10px] text-[#7A7060] mb-2 uppercase tracking-wider">Standard — Floor 1</div>
                <div className="flex flex-wrap gap-1 mb-3">
                  {['101','102','103','104','105','106','107','108','109','110','111','112'].map((n, i) => (
                    <div key={n} className={`w-9 h-8 flex items-center justify-center text-[10px] font-medium border ${
                ...
                <div className="text-[10px] text-[#7A7060] mb-2 uppercase tracking-wider">Deluxe — Floor 2</div>
      ...
      <section className="py-20 max-w-6xl mx-auto px-6" id="features">
        <div className="max-w-lg mb-14">
          <p className="text-xs uppercase tracking-[0.2em] text-[#7A7060] dark:text-[#9A9080] mb-4">Why hotel owners use StayFlow</p>
          <h2 className="text-3xl font-bold leading-snug">
            Stop losing track of who's in which room.
          </h2>
        </div>

        <div className="grid md:grid-cols-3 gap-px bg-[#DDD8CC] dark:bg-white/8 border border-[#DDD8CC] dark:border-white/8">
          {[
            {
              icon: BedDouble,
            ...
            },
            {
              ...
              detail: 'Required by Indian law for hotel check-ins. StayFlow handles it cleanly.',
            },
            {
              icon: BarChart3,
            ...
            <div key={title} className="bg-[#F8F6F1] dark:bg-[#141210] p-8">
      ...
      {/* How it works */}
      <section className="py-20 bg-white dark:bg-[#1E1B17] border-y border-[#DDD8CC] dark:border-white/8" id="how">
        <div className="max-w-6xl mx-auto px-6">
          <div className="max-w-lg mb-14">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              <div key={n}>
                <span className="text-4xl font-bold text-[#DDD8CC] dark:text-white/10">{n}</span>
                <h3 className="font-semibold text-sm mt-3 mb-2">{title}</h3>
      ...
      <section className="py-20 max-w-6xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-px bg-[#DDD8CC] dark:bg-white/8 border border-[#DDD8CC] dark:border-white/8">
          <div className="bg-[#F8F6F1] dark:bg-[#141210] p-10">
          ...
          <div className="bg-[#2F4F2F] dark:bg-[#1A2A1A] p-10 flex flex-col justify-between">
            <div>
              <p className="text-xs uppercase tracking-[0.2em] text-white/40 mb-6">Everything in the 7-day trial</p>
      ...
      {/* Pricing */}
      <section className="py-20 bg-white dark:bg-[#1E1B17] border-y border-[#DDD8CC] dark:border-white/8" id="pricing">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-px bg-[#DDD8CC] dark:bg-white/8 border border-[#DDD8CC] dark:border-white/8">
            ...
            {/* Free Trial */}
            <div className="bg-[#F8F6F1] dark:bg-[#141210] p-8 flex flex-col">
              <div className="mb-6">
            ...
            {/* Pro */}
            <div className="bg-[#2F4F2F] dark:bg-[#1A2A1A] p-8 flex flex-col relative">
          ...
          {/* FAQ-style note */}
          <div className="mt-10 grid md:grid-cols-3 gap-6 text-sm text-[#7A7060] dark:text-[#9A9080]">
            ...
            <p><span className="text-foreground font-medium">What happens after the trial?</span> Your account is paused — your data is safe. Upgrade to keep using StayFlow.</p>
